...
void Robot::RobotPeriodic() {
  ...
  m_feedback.gyro.SetDouble(m_drivetrain.GetAngle());
  m_feedback.distance_traveled.SetDouble(m_drivetrain.GetDistance());
  ...
  frc::SmartDashboard::PutNumber("Color", m_control_panel.GetColor());
  frc::SmartDashboard::PutNumber("Distance Traveled", m_drivetrain.GetDistance());
