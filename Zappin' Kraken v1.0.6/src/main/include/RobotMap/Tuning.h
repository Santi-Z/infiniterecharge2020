...
constexpr double drivetrain_angle_kP = 0.008;
...
constexpr double kIntakeMidTarget = 30;                         //Degrees
...
constexpr double kFastFeedShooterTimeout = 1.1;                 //Seconds
constexpr double kFeedShooterTimeout = 2;                       //Seconds
constexpr double kSlowFeedShooterTimeout = 3;                   //Seconds
...
//Elevator
constexpr double kElevatorTarget = 60;                          //Inches to bottom of slider
constexpr double kElevatorRaiseSpeed = 1;

constexpr double elevator_kP = 0.0148;
constexpr double elevator_kI = 0;
constexpr double elevator_kD = 0;

//Control Panel
constexpr double kRotationControlSpeed = 0.5;
constexpr double kPositionControlSpeed = 0.5;
constexpr double kPositionControlDelay = 0.07;                  //Seconds
...
//Auto
constexpr double x_offset_kP = 0.02;
